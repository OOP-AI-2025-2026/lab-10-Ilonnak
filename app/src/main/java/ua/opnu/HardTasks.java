...
public class HardTasks {
    ...
    public static void main(String[] args) {
        ...
        // Для того, щоб побачити в консолі результат роботи методу,
        // разкоментуйте відповідний рядок коду

        // Завдання 1
        // Objects.requireNonNull(tasks.getBooksWithPrice(),
        //         "Method getBooksWithPrice() returns null")
        //         .forEach(System.out::println);

        // Завдання 2
        // Objects.requireNonNull(tasks.getOrdersWithBabyProducts(),
        //         "Method getOrdersWithBabyProducts() returns null")
        //         .forEach(System.out::println);

        // Завдання 3
        // Objects.requireNonNull(tasks.applyDiscountToToys(),
        //         "Method applyDiscountToToys() returns null")
        //         .forEach(System.out::println);

        // Завдання 4
        // System.out.println(Objects.requireNonNull(tasks.getCheapestBook(),
        //         "Method getCheapestBook() returns null").get());

        // Завдання 5
        // Objects.requireNonNull(tasks.getRecentOrders(),
        //         "Method getRecentOrders() returns null")
        //         .forEach(System.out::println);

        // Завдання 6
        // DoubleSummaryStatistics statistics =
        //         Objects.requireNonNull(tasks.getBooksStats(),
        //                 "Method getBooksStats() returns null");
        // System.out.printf("count = %1$d, average = %2$f, max = %3$f, min = %4$f, sum = %5$f%n",
        //         statistics.getCount(), statistics.getAverage(),
        //         statistics.getMax(), statistics.getMin(), statistics.getSum());

        // Завдання 7
        // Objects.requireNonNull(tasks.getOrdersProductsMap(),
        //         "Method getOrdersProductsMap() returns null")
        //         .forEach((id, size) -> System.out.printf("%1$d : %2$d\n", id, size));

        // Завдання 8
        // Objects.requireNonNull(tasks.getProductsByCategory(),
        //         "Method getProductsByCategory() returns null")
        //         .forEach((name, list) ->
